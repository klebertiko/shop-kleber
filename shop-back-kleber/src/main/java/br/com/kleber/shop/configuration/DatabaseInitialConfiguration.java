...
public class DatabaseInitialConfiguration {
    ...
    public void initializeValues() {
        ...
        this.productRepository.save(new Product(1L, "Dell Inspiron 15 Gaming",
                ...
                new BigDecimal(4269.90),
                10));

        this.productRepository.save(new Product(2L, "Logitech Proteus Spectrum G502",
